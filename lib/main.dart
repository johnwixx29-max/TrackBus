...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: [
          // Full blue background covering header area
          Container(
            height: 360,
              ...
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: const Color(0xFFF4A024).withOpacity(0.07),
                    ),
                  ),
                ),
                // bottom-left accent
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                    ...
                    child: Row(
                      children: [
                        ...
                        const Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              TrackBusLogoText(fontSize: 26),
                              Text('Belagavi, Karnataka',
                                  style: TextStyle(
                  ...
                  const SizedBox(height: 24),
                  // White card area — Recently Travelled
                  Container(
                    decoration: const BoxDecoration(
                      ...
                      child: Column(
                          ...
                          children: [
                            Row(children: [
                              ...
                              const Text('Recently Travelled',
                                  style: TextStyle(
                                      fontSize: 15,
                                      fontWeight: FontWeight.w700,
                                      color: Color(0xFF1A1A2E))),
                              const Spacer(),
                              Text('${UserSession.travelHistory.length} trips',
                                  style: const TextStyle(
                                      fontSize: 12, color: Colors.grey)),
                            ]),
                            const SizedBox(height: 4),
                            const Text('Your recent bus journeys',
                                style: TextStyle(
                                    fontSize: 12, color: Colors.grey)),
                            const SizedBox(height: 12),
                            if (UserSession.travelHistory.isEmpty)
                              Container(
                                ...
                                child: const Column(children: [
                                  ...
                                  SizedBox(height: 4),
                                  Text(
                                      'Search and travel to see your history here',
                                      style: TextStyle(
                                          fontSize: 12, color: Colors.grey),
                    ...
                    Row(children: [
                      ...
                      Container(
                        ...
                        child: Row(children: const [
                          Icon(Icons.bookmark,
                              color: Color(0xFFF4A024), size: 14),
                          SizedBox(width: 5),
                          Text('Saved Routes',
                              style: TextStyle(
                                  color: Colors.white,
