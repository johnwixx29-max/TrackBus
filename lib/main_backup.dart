...
class AuthService {
  ...
  static Future<String> sendNewEmailOtp(String newEmail) async {
    ...
    if (_users
        .any((u) => u.email.toLowerCase() == newEmail.trim().toLowerCase())) {
  ...
  static Future<String?> commitEmailChange() async {
    ...
    if (existing == null || newEmail == null)
      return 'Complete email verification first';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _sendNewEmailOtp() async {
    ...
    try {
      ...
      _snack(e.toString().contains('registered')
              ...
              if (!_changingEmail) ...[
                ...
                Align(
                  ...
                  child: TextButton(
                    ...
                    child: const Text('Change Email (OTP verification)',
                        style: TextStyle(
                            color: Color(0xFF1A3A5C),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_emailStep == 1) ...[
                        Text('OTP sent to $_originalEmail',
                            style: TextStyle(
                        ...
                        const SizedBox(height: 10),
                        ElevatedButton(
                            onPressed: _sendNewEmailOtp,
                            style: _otpBtnStyle(),
                            child: const Text('Send OTP to New Email')),
                      ] else ...[
                        _AuthField(
                        ...
                        const SizedBox(height: 10),
                        ElevatedButton(
                            onPressed: _verifyNewOtpAndFinishEmail,
                            style: _otpBtnStyle(),
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void initState() {
    ...
    Future.delayed(const Duration(seconds: 2), () {
      if (!mounted) return;
      final next =
          AuthService.isLoggedIn ? const MainShell() : const RegisterScreen();
      Navigator.pushReplacement(
                      ...
                      child: const Row(
                        children: [
                          Icon(Icons.location_on,
                              color: Color(0xFFF4A024), size: 18),
                          SizedBox(width: 8),
                          Text('My Current Location — CBT',
                              style: TextStyle(
                                  color: Colors.white,
                                  fontSize: 13,
      ...
      children: [
        ...
        Text(
          history.isEmpty
              ...
              : '${history.length} recent trip${history.length == 1 ? '' : 's'}',
              ...
              children: [
                ...
                Text('No trips yet',
                    style: TextStyle(
                        ...
                        fontWeight: FontWeight.w500)),
                const SizedBox(height: 6),
                Text('Search a bus route to start tracking',
                    style:
                ...
                child: Row(
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        Text(t['lastTravelled'] as String? ?? 'Recent',
                            style: TextStyle(
...
class _SearchScreenState extends State<SearchScreen> {
                ...
                : _results.isEmpty
                    ...
                    : ListView(
                        ...
                        children: [
                          ...
                          ..._results
                              .map((bus) => _ResultTile(
                                  bus: bus, destination: _to, from: _from))
                              .toList(),
                        ],
                      ),
          ),
  ...
  Widget _noResult() => Center(
        ...
        const SizedBox(height: 6),
        const Text('Try a nearby stop or route via CBT',
...
class _ResultTile extends StatelessWidget {
  ...
  final String from;
  const _ResultTile(
      {required this.bus, required this.destination, required this.from});
              ...
              Expanded(
                  child: Column(
                    ...
                    Text(bus.route,
                        ...
                        overflow: TextOverflow.ellipsis),
                    const SizedBox(height: 4),
                    Text('${bus.busType} • Departs ${bus.departureTime}',
                        style: TextStyle(
            ...
            child: Column(
              ...
              children: [
                ...
                _SearchDetailRow(
                    ...
                    label: 'Conductor',
                    value: bus.conductorName),
                if (arrival != null)
                  _SearchDetailRow(
                      icon: Icons.schedule,
                      label: 'At your stop ($from)',
                      value: arrival),
                _SearchDetailRow(
                        ...
                        child: hasPhoto
                            ? ClipOval(
                                child: Image.file(File(u.photoPath!),
                                    fit: BoxFit.cover))
                            : const Icon(Icons.person,
                                color: Color(0xFF1A3A5C), size: 48),
                      ),
                      Positioned(
                        bottom: 0,
                        right: 0,
                        child: Container(
                          ...
                          height: 26,
                          decoration: const BoxDecoration(
                              color: Color(0xFFF4A024), shape: BoxShape.circle),
